import { INTERFACE_IDS as IDS } from '@lukso/lsp-smart-contracts';
...
export const INTERFACE_IDS = {
  LSP7DigitalAsset: IDS.LSP7DigitalAsset,
  LSP8IdentifiableDigitalAsset: IDS.LSP8IdentifiableDigitalAsset,
};
