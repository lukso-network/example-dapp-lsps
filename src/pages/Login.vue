...
<template>
  <div class="center">
    <h2>LUKSO Example dApp</h2>
    <h3>Universal Profiles, Tokens (LSP7) and NFTs (LSP8)</h3>
  </div>
  <br />

  <p class="note" v-if="useOnlyOneExtension">
    If you have MetaMask AND Universal Profile Browser Extension installed, please disable one of them! See these guides for
